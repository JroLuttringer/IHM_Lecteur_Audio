...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        treeWidget->setGeometry(QRect(20, 10, 301, 511));
        ...
        verticalFrame_right->setFrameShape(QFrame::StyledPanel);
        verticalFrame_right->setFrameShadow(QFrame::Sunken);
        ...
        pushButton_pirate = new QPushButton(verticalFrame_right);
        pushButton_pirate->setObjectName(QStringLiteral("pushButton_pirate"));
        pushButton_pirate->setMaximumSize(QSize(40, 16777215));

        language_layout->addWidget(pushButton_pirate);
        ...
        lineEdit->setStyleSheet(QStringLiteral("font-size: 30px;"));
        ...
        lcdNumber_length->setFrameShadow(QFrame::Plain);
        lcdNumber_length->setLineWidth(2);
        ...
        pushButton_mute->setStyleSheet(QStringLiteral("border: 1px solid gray; border-radius: 5px;background-color:brown;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_pirate->setText(QApplication::translate("MainWindow", "PIR", Q_NULLPTR));
